...
public /* abstract */class ResultHandlerBase implements IResultHandler {
   ...
   public function handleCompletion(command:String, rows:int, oid:int, token:QueryToken):void {
      doHandleCompletion(command, rows, oid, token);
      _columns = null;
      _data = null;
   }
    ...
    */
   public /* abstract */function doHandleCompletion(command:String, rows:int, oid:int, token:QueryToken):void {
