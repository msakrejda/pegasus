...
internal class SimpleQueryHandler extends EventDispatcher implements IQueryHandler {
   ...
   protected var _token:QueryToken;
    ...
    */
   public function SimpleQueryHandler(resultHandler:IResultHandler, codecs:CodecFactory, token:QueryToken) {
    ...
    */
   public function handleCompletion(command:String, rows:int=0, oid:int=-1, token:QueryToken=null):void {
      _resultHandler.handleCompletion(command, rows, oid, this._token);
   }
