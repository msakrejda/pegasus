    ...
    public class TestDateFormatter {
        ...
        public static function getTestDates():Array {
            return [
                ...
                [ new Date(2134, 4, 6, 7, 8, 0, 9), 'Q', '9' ],
                [ new Date(2134, 4, 6, 7, 18, 0, 19), 'Q', '19' ],
                [ new Date(2134, 4, 6, 7, 18, 0, 192), 'Q', '192' ],
                [ new Date(2134, 4, 6, 7, 8, 0, 9), 'QQ', '09' ],
                [ new Date(2134, 4, 6, 7, 18, 0, 19), 'QQ', '19' ],
                [ new Date(2134, 4, 6, 7, 18, 0, 192), 'QQ', '192' ],
                [ new Date(2134, 4, 6, 7, 8, 0, 9), 'QQQ', '009' ],
                [ new Date(2134, 4, 6, 7, 18, 0, 19), 'QQQ', '019' ],
                [ new Date(2134, 4, 6, 7, 18, 0, 192), 'QQQ', '192' ],
                [ new Date(2134, 4, 6, 7, 8, 9, 555), 'YYYY-MM-DD JJ:NN:SS.QQQ', '2134-05-06 07:08:09.555' ],
                [ new Date(2134, 4, 6, 7, 8, 9, 555), '\\Y\\Y\\Y\\Y-\\M\\M-\\D\\D \\J\\J:\\N\\N:\\S\\S.\\Q\\Q\\Q', 'YYYY-MM-DD JJ:NN:SS.QQQ' ]
            ];
        }
